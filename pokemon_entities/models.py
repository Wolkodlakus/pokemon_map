...
class Pokemon(models.Model):
    ...
    title_en = models.CharField(verbose_name='Название по английски', max_length=200, default='', blank=True)
    title_jp = models.CharField(verbose_name='Название по японски', max_length=200, default='', blank=True)
...
class PokemonEntity(models.Model):
    ...
    appeared_at = models.DateTimeField(verbose_name='Время появление', null=True)
